 ...
 */
final class Version20220226101321 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE `closing_rate` (id INT AUTO_INCREMENT NOT NULL, date DATE NOT NULL, fup INT NOT NULL, shofup INT NOT NULL, back INT NOT NULL, closefup INT NOT NULL, leads INT NOT NULL, leads_valid INT NOT NULL, leads_contact INT NOT NULL, leads_offer INT NOT NULL, leads_fup INT NOT NULL, leads_close INT NOT NULL, leads_confirm INT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
    }

    public function down(Schema $schema): void
    {
        // this down() migration is auto-generated, please modify it to your needs
        $this->addSql('DROP TABLE `closing_rate`');
