 ...
 */
final class Version20220215172626 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE member_cpf CHANGE name last_name VARCHAR(255) NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE member_cpf ADD name VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`, DROP last_name, CHANGE email email VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE training training VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE date_creation date_creation VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`');
