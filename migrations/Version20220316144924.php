 ...
 */
final class Version20220316144924 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE offer ADD front_name VARCHAR(255) NOT NULL');
    }
