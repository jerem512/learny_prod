...
final class Version20220215174352 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE member_cpf CHANGE lead_id lead_id VARCHAR(255) NOT NULL');
    }
