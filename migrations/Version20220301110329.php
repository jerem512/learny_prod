 ...
 */
final class Version20220301110329 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE category ADD closer_id INT NOT NULL');
    }

    public function down(Schema $schema): void
    {
        // this down() migration is auto-generated, please modify it to your needs
        $this->addSql('ALTER TABLE category DROP closer_id, CHANGE lead_category lead_category VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`');
