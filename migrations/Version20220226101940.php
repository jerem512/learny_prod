 ...
 */
final class Version20220226101940 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE closing_rate ADD user_id_id INT NOT NULL');
        $this->addSql('ALTER TABLE closing_rate ADD CONSTRAINT FK_D222D7709D86650F FOREIGN KEY (user_id_id) REFERENCES users (id)');
        $this->addSql('CREATE INDEX IDX_D222D7709D86650F ON closing_rate (user_id_id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE `closing_rate` DROP FOREIGN KEY FK_D222D7709D86650F');
        $this->addSql('DROP INDEX IDX_D222D7709D86650F ON `closing_rate`');
        $this->addSql('ALTER TABLE `closing_rate` DROP user_id_id');
