 ...
 */
final class Version20220312105315 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE users ADD api_key_learnybox VARCHAR(255) DEFAULT NULL, ADD subdomain_learnybox VARCHAR(255) DEFAULT NULL');
    }
