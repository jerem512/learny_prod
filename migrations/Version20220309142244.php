 ...
 */
final class Version20220309142244 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE close ADD offer_id INT NOT NULL, DROP name');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE close ADD name VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`, DROP offer_id');
