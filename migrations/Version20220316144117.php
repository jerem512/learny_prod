 ...
 */
final class Version20220316144117 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE offer ADD nb_monthly_payment VARCHAR(255) NOT NULL');
    }
