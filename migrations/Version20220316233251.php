 ...
 */
final class Version20220316233251 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE closing_rate_backup (id INT AUTO_INCREMENT NOT NULL, user_id_id INT NOT NULL, date DATE NOT NULL, fup INT NOT NULL, shofup INT NOT NULL, back INT NOT NULL, closefup INT NOT NULL, leads INT NOT NULL, leads_valid INT NOT NULL, leads_contact INT NOT NULL, leads_offer INT NOT NULL, leads_fup INT NOT NULL, leads_close INT NOT NULL, leads_confirm INT NOT NULL, INDEX IDX_12CCC7E59D86650F (user_id_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('ALTER TABLE closing_rate_backup ADD CONSTRAINT FK_12CCC7E59D86650F FOREIGN KEY (user_id_id) REFERENCES users (id)');
    }

    public function down(Schema $schema): void
    {
        // this down() migration is auto-generated, please modify it to your needs
        $this->addSql('DROP TABLE closing_rate_backup');
        $this->addSql('ALTER TABLE category CHANGE lead_category lead_category VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`');
        $this->addSql('ALTER TABLE close CHANGE name name VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`');
        ...
        $this->addSql('ALTER TABLE offer CHANGE name name VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE price price VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE price_ht price_ht VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE commission commission VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE nb_monthly_payment nb_monthly_payment VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE front_name front_name VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`');
