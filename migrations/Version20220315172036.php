 ...
 */
final class Version20220315172036 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE objectives (id INT AUTO_INCREMENT NOT NULL, goal_week INT NOT NULL, goal_month INT NOT NULL, goal_year INT NOT NULL, user_id INT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
    }
